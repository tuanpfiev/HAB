        ...
        if handshake:
            ...
            if (len(dataOut) >= 2): 
                ...
                # otherwise 
                    ...
                    # format log string 
                    logString = str(handshakeTime) + "," + str(rssi.targetPayloadID) + "," + str(filtered_RSSI) + "," + str(distance) + "\n"
                    timeCheck2 = time.time()
                    print("Handshake dt: ",dt)
                    print("loop: ",timeCheck2-timeCheckPrev)
                    timeCheckPrev = copy.deepcopy(timeCheck2)
                    dt = timeCheck2-timeCheck1
