...
if __name__ == "__main__":
    ...
    RSSIThread = [0]* (GlobalVals.N_REAL_BALLOON-1)
    ...
    while True:
        ...
        with GlobalVals.RSSI_UPDATE_MUTEX:
            distance = copy.deepcopy(GlobalVals.RSSI.distance)
        ...
        location,_,iteration = balloon_main(leader,GlobalVals.ANCHOR,posXYZ_tmp,sigma_range_measurement_val,distance)
