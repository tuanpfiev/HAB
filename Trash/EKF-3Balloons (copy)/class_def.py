...
class settings:
    ...
    ## Set EKF parameters 
    ##
    sigma_acc = np.array([0.05, 0.05, 0.05])*10
    sigma_gyro = np.array([0.1*np.pi/180, 0.1*np.pi/180, 0.1*np.pi/180])*10
    sigma_acc_bias = np.array([1e-4, 1e-4, 1e-4])*10
    sigma_gyro_bias = np.array([0.01*np.pi/180, 0.01*np.pi/180, 0.01*np.pi/180])*10
