...
#echo ${neighborBalloon[1]}	
	...
	sleep 2; xterm -geometry 90x30+800+0 -title "GPS Logger" -hold -e "cd ~/HAB/GPS-Loggers-old; python3 GPSLoggerUART.py /dev/ttyUSB3" &
	sleep 3; xterm -geometry 90x30+1400+0 -title "Network" -hold -e "cd ~/HAB/Simple-RFD900-Network; python3 RadioNetworkMain.py $1"&
	sleep 4; xterm -geometry 90x30+1400+450 -title "Lora1" -hold -e "cd ~/HAB/LoRa-Radio-RSSI; python3 LoraRadio.py start /dev/ttyUSB1 ${neighborBalloon[0]} $1" &
	sleep 4.1; xterm -geometry 90x30+1400+450 -title "Lora2" -hold -e "cd ~/HAB/LoRa-Radio-RSSI; python3 LoraRadio.py wait /dev/ttyUSB2 ${neighborBalloon[1]} $1"
