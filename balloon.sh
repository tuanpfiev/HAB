...
#	xterm -geometry 90x30+1400+0 -title "Network" -hold -e "cd ~/HAB/Simple-RFD900-Network; python3 RadioNetworkGS.py"
	...
	sleep 8; xterm -geometry 90x30+800+450 -title "Localisation" -hold -e "cd ~/HAB/localisation-RSSI; python3 localisation_main.py"&			sleep 8.5; xterm -title "EKF" -hold -e "cd ~/HAB/EKF; python3 main_EKF.py $1"
#fi
